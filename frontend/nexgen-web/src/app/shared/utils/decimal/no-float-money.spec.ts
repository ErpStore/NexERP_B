...
const EXEMPT = new Map<string, string>([
  ...
  [
    'app/shared/components/data-grid/data-grid-header.component.ts',
    'Column resize width in pixels, not money (M2-C05-01).',
  ],
  [
    'app/shared/components/data-grid/data-grid-pagination.component.ts',
    'Page count from a row total, not money (M2-C05-01).',
  ],
  [
    'app/shared/components/data-grid/data-grid-query-state.ts',
    'Page count from a row total, not money (M2-C05-01).',
  ],
  [
    'app/shared/components/data-grid/data-grid.component.ts',
    'Column resize width in pixels, not money (M2-C05-01).',
  ],
  [
    'app/shared/components/overlay/drawer.component.ts',
    'Drawer width in pixels, not money (M2-C04-03).',
  ],
  [
