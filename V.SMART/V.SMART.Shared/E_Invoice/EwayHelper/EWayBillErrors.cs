...
{
    public static class EWayBillErrors
    {
        public static readonly Dictionary<int, string> ErrorCodeDescriptions = new Dictionary<int, string>
    {
        { 100, "Invalid Json" },
        ...
        { 236, "Tax rates for Interstate transaction is blank" },
        ...
        { 283, "HSN Code must contain at least 6 digits. Please update the item HSN code and try again."},
        ...
        { 366, "You will not get the eway bills generated today, however you can access the eway bills of yesterday" },
        ...
        { 370, "GSTIN/Transin passed in request header should not be the same as supplier (from GSTIN) or recipient (to GSTIN)" },
        ...
        { 378, "The supplier or consignee belong to SEZ, Interstate tax rates are applicable here" },
        ...
        { 382, "You Cannot Extend as EWB can be Extended only 8 hour before or after w.r.t" },
        { 383, "Error While Extending, Please Contact Helpdesk" },
        { 384, "You are not current transporter or Generator of the eway Bill, with no transporter details" },
        ...
        { 399, "Unit Code is not matching with any of the Unit Code from Item List" },
        ...
        { 703, "Since the consignor is Composite Taxpayer, interstate transactions are not allowed" },
        ...
        { 710, "Invalid state code for the given pin code" },
        ...
        { 721, "The distance between the given pin codes is not available in the system. Please provide distance" },
        ...
        {
            return ErrorCodeDescriptions.TryGetValue(errorCode, out var description) ? description : "Unknown Error Code";
        }
    }
}
