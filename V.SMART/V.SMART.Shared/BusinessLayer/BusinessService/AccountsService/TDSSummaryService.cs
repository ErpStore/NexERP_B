...
{
    public class TDSSummaryService : ITDSSummaryService
    {
        ...
        public async Task<List<TDSReportVM>> GetTDSSummaryReportAsync(string reportTopic,DateTime? fromDate, DateTime? toDate)
        {

            try
            {
                var result = await _report.ExecuteAsync<TDSReportVM>("Sp_TDSReport",
