...
{
    public class HSNSummaryService : IHSNSummaryService
    {
        ...
        public async Task<List<HSNSummaryVM>> GetHSNSummaryReportAsync(string reportTopic, DateTime? fromDate, DateTime? toDate)
        {

            try
            {
                var result = await _report.ExecuteAsync<HSNSummaryVM>("Sp_GetHSNSummaryReport",
