...
{
    public interface ICreditDebitSummaryService
    {
        ...
        Task<List<CreditNoteDebitNoteSummaryVM>> GetCreditDebitSummaryReportAsync(string reportTopic, DateTime? fromDate, DateTime? toDate);
    }
}
