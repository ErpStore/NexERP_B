...
{
    public class MaterialIssueSubProfile : Profile
    {
        public MaterialIssueSubProfile()
        {
            // ===================== Entity → ViewModel =====================
            CreateMap<MaterialIssNoteSub, MaterialIssNoteSubVM>()
                 // Item Details
            ...
            // ===================== ViewModel → Entity =====================
            CreateMap<MaterialIssNoteSubVM, MaterialIssNoteSub>()
                .ForMember(dest => dest.Item, opt => opt.Ignore())
                .ForMember(dest => dest.CostCenter, opt => opt.Ignore())
                .ForMember(dest => dest.MaterialIssNote, opt => opt.Ignore());
        }
    }
}
