...
{
    public class CreditNoteSub
    {
        [Key]
        public int CrSubId { get; set; }

        public int CrId { get; set; }
        [ForeignKey(nameof(CrId))]
        ...
        [ForeignKey(nameof(RefInvSubId))]
        public MfgInvSub? MfgInvSub { get; set; }


        public int? LabInvSubId { get; set; }
        [ForeignKey(nameof(LabInvSubId))]
        public LabInvSub? LabInvSub { get; set; }

        public int? ExpInvSubId { get; set; }
        [ForeignKey(nameof(ExpInvSubId))]
        public ExpInvSub? ExpInvSub { get; set; }
