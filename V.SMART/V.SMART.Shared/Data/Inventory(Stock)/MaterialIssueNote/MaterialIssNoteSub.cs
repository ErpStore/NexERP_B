...
{
    public class MaterialIssNoteSub
    {
        [Key]
        public int MINSubId { get; set; }

        [Required]
        public int MINId { get; set; }

        [ForeignKey(nameof(MINId))]
        public MaterialIssNote MaterialIssNote { get; set; } = null!;
        ...
        public int? RefRequestSubId { get; set; }
        [ForeignKey(nameof(RefRequestSubId))]
        public virtual StockIssueRequestSub? StockIssueRequestSub { get; set; }
    }
}
