...
namespace V.SMART.Shared.Repository.SalesAndLabourRepository.MfgQuotation
{
    ...
    public class MfgQuoteSubRepository: Repository<MfgQuoteSub>, IMfgQuoteSubRepository
    {
        private readonly ApplicationDbContext _db;
        private readonly ILoggingService _loggingService;
        private readonly CurrentUserService _currentUserService;
        public MfgQuoteSubRepository(
        ...
        public async Task<List<MfgQuoteSub>> GetMfgSubDataByQuoteId(int quoteId)
        {
            return await _db.MfgQuoteSub
