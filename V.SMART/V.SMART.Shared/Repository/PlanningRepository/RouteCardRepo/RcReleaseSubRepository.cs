...
{
    public class RcReleaseSubRepository : Repository<RouteCardReleaseSub>, IRcReleaseSubRepository
    {
        private readonly ApplicationDbContext _db;
        private readonly ILoggingService _logs;
        public RcReleaseSubRepository(ApplicationDbContext db, ILoggingService logs) : base(db, logs)
        {
            _db = db;
            _logs = logs;
        }
