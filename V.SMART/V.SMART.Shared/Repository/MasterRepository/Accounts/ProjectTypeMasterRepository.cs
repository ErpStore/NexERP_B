...
namespace V.SMART.Shared.Repository.MasterRepository.Accounts
{
    public class ProjectTypeMasterRepository : Repository<ProjectTypeMaster>, IProjectTypeMasterRepository
    {
        ...
        public ProjectTypeMasterRepository(ApplicationDbContext db, ILoggingService loggingService, CurrentUserService currentUserService) : base(db, loggingService)
        {
            _db = db;
        ...
        public override async Task<ProjectTypeMaster> UpdateAsync(ProjectTypeMaster obj)
        {
            try
            {
                var tracked = await _db.ProjectTypeMaster.FirstOrDefaultAsync(s => s.Id == obj.Id);
                if (tracked == null)
                    return new ProjectTypeMaster();
                ...
                await _loggingService.LogUserAction(
                    ...
                    screen: "Type of project Master",
                    action: "Type of project Master data modified",
            ...
            {
                await _loggingService.LogDeveloperError(ex, "Error in ProjectTypeMasterRepository.UpdateAsync");
                return new ProjectTypeMaster();
            }
        }
    }
