...
{
    public class ProductionReturnAssyVM
    {
        ...
        [ValidateComplexType]
        public List<ProductionReturnAssySubVM> ProductionReturnAssySubVMs { get; set; } = new();
        public List<ProductionReturnAssyTrackVM> ProductionReturnAssyTrackVMs { get; set; } = new();
