...
namespace V.SMART.Shared.ViewModels.HumanResourceViewModel.SalaryViewModel
{
    public class SalaryVM
    {
        public string HRAType { get; set; } = "FixedMonth";
        public int RowId { get; set; }

        [Required(ErrorMessage = "Please select a Salary Year.")]
        public int? SalYear { get; set; }

        [Required(ErrorMessage = "Please select a Salary Month.")]
        public int? SalMonth { get; set; }

        public DateTime SalDate { get; set; } = DateTime.Now;

        public bool SalaryCancel { get; set; } = false;
        ...
        public bool EnableAttendanceEdit { get; set; }
        ...
        public decimal DeductionLeaveDays { get; set; }
        ...
        public decimal OTBaseAmount { get; set; }
        //public decimal OT { get; set; }           // OT hours
        //public decimal OT_times_now { get; set; } // OT multiplier / times
        //public bool IsOTunderBasic { get; set; }  // use formula under gross
        //public bool IsOTPerHour { get; set; }
    }
}
