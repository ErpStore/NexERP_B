...
| INV-042 | Which of `M2-B04`'s 16 `Pages`-reference directives are safe to delete vs. load-bearing | M2-B04 | **Claimed 2026-08-21 — `Partial`, see the Partial table above. The directive analysis and the guard test are done; it stays `Partial` for the MAUI-head build (unverifiable here) and Q-55.** |
| **INV-043 +** | **next free** | — | — |
