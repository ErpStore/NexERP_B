...
| **INV-046 +** | **next free** *(INV-043 is double-claimed on the unmerged `migration/M2-A07-me-endpoint` and `migration/M2-B04-decouple-pages-references` branches; INV-045 was claimed by M2-B06 on 2026-08-21 — check `git branch --no-merged master` before claiming)* | — | — |
