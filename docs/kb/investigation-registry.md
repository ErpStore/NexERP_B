...
| **INV-049 +** | **next free** *(INV-042 was double-claimed by `M2-A07` and `M2-B04`; resolved at merge 2026-08-21 — M2-A07 keeps INV-042, M2-B04 became INV-047. INV-045 was claimed by M2-B06, INV-046 by M2-B11, INV-048 by M2-C13. Check `git branch --no-merged master` before claiming)* | — | — |
