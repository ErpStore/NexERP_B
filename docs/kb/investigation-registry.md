...
| **INV-045 +** | **next free** *(INV-043 is double-claimed on the unmerged `migration/M2-A07-me-endpoint` and `migration/M2-B04-decouple-pages-references` branches — check `git branch --no-merged master` before claiming)* | — | — |
