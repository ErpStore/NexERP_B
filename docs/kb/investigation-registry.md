...
| INV-006 | Existing UI: routing, layout, components, `@code` density | Complete *(amended 2026-08-19 by M2-C04-01 — theme persistence; amended again 2026-08-23 by M2-C04-01 — how PrimeNG 22 consumes the token layer, the answer to Q-67; amended 2026-08-23 by M2-C04-02 — the DataAnnotations to Angular validator mapping surface, and the cross-field caveat; refined 2026-08-25 by M2-C05-01 — the list-grid inventory, INV-053 below, which corrects a widely repeated assumption about MudDataGrid; see below)* | `Routes.razor`, `Layout/NavMenu.razor` (888 LOC), `Components/` (22), `Pages/` (333 files, 440 routes), measured `@code` share | [KB-015](architecture/frontend-architecture-existing.md) | 2026-08-12 |
