...
| M2-A05    | M2        | Cross-origin SPA tenant resolution + real CORS                    | Security      | Blocked¹¹² _(re-specified for Angular by `M2-A11`, 2026-08-27 — no longer stale, but its own Prerequisites still require Q-16 answered or explicitly deferred with a recorded reason, and `open-questions.md` currently records neither for this task specifically. See footnote ¹¹²)_ | P0       | M2-A04                                                         | 3–5 d    | G2   |
