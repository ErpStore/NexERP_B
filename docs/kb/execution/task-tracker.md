...
| M2-C08-01 | M2        | — layout: header + lines + totals + commands                          | Frontend      | **Blocked**⁴⁶˒¹⁰⁴˒¹¹⁰ _(corrected 2026-08-27 — `Ready` was stale: the file's own `depends_on` also names `M2-C03`, `M2-C04-02`, `M2-C04-03`, `M2-C02` as Hard, and `M2-C03` is `Needs Review`, not `Completed`. See footnote ¹¹⁰)_                                                                                                                                                                                                                 | P0       | M2-C07, M2-C04-02, M2-C04-03, M2-C03, M2-C02 | 4 d      | G2   |
