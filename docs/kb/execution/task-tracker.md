...
| M2-B12-01 | M2 | — INV-012 numbering investigation | Investigation | **Blocked**²⁸ *(escalation budget exhausted; awaiting owner Vivek's decision; on `migration/M2-B12-01-inv-012-numbering` `8a54f96`, unmerged)* | P0 | M2-B07 | 2 d | G2 |
