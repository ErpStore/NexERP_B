...
| M2-A05    | M2        | Cross-origin SPA tenant resolution + real CORS                    | Security      | **Ready**¹¹²˒¹¹³ _(re-specified for Angular by `M2-A11`; Q-16 explicitly deferred 2026-08-27, owner asked directly and answered "I don't know" — recorded in `open-questions.md`. All five parts of the "can actually be done" test now clear. See footnotes ¹¹²–¹¹³)_       | P0       | M2-A04                                                         | 3–5 d    | G2   |
